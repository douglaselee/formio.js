...
export function checkCustomConditional(component, custom, row, data, form, variable, onError, instance) {
  ...
  const value = (instance && instance.evaluate) ?
    instance.evaluate(custom, { component, row, data, form, instance, util: this, moment }) :
    evaluate(custom, { component, row, data, form, instance, util: this, moment });
  if (value === null) {
    return onError;
  }
  return value;
...
export function checkCondition(component, row, data, form, instance) {
  if (component.customConditional) {
    ...
    return this.checkJsonConditional(component, component.conditional.json, row, data, form, instance);
  }
