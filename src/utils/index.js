  ...
  checkCalculated(component, submission, rowData, user) {
    ...
    if (component.calculateValue) {
      ...
      if (_.isString(component.calculateValue)) {
        try {
          _.set(rowData, component.key, (new Function('component', 'data', 'row', 'util', 'moment', 'user', 'submission',
            `var value = [];${component.calculateValue.toString()}; return value;`))(component, data, row, this, moment, user, submission));
        }
        catch (e) {
